"""
Ejercicio 10. Crear un programa que pida al usuario las notas de 15 alumnos
y mostrar quiénes aprobaron y reprobaron
...
aprobados=0
reprobados=0
numero_de_alumnos= int(input("Ingrese el número de alumnos: "))
