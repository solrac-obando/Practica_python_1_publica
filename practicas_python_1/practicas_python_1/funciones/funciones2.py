...
# ejemplo 5 de return o devolucion de datos
def saludame(nombre):
...
def getApellido(apellidos):
    texto = f"los  Apellidos es: {apellidos}"
    return texto
...
print("\n###################### Ejercicios 7 ####################")
# funciones lambda, son funciones anonimas para realizar codigo simple o operaciones concretas
dime_el_year =lambda year: f"the year is {year * 2}"
#year= 2026
print(dime_el_year(1013))# se debe de imprimir con la variable que se definio en la funcion lambda
