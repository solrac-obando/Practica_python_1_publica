# programa para determinar si el usuario es apto para trabajar de acuerdo a las leyes del país
""" operadores de lógicos en las condicionales:
...
if edad_usuario >= edad_minima and edad_usuario <= edad_maxima:
    ...
    print("Entendemos que deseas trabajar pero eres muy joven para ello en este país")
...
pais = input("Nos puedes decir de que país eres?: ")
if pais == "argentina" or pais == "Venezuela" or pais == "México" or pais == "colombia" or pais == "España":
